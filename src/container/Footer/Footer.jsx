...
const Footer = () => {
  ...
  return (
    <>
    <h2 className='head-text'>Take a cofee</h2>
    <div className='app__footer-cards'>
      <div className='app__footer-card'>
        <img src={images.email} alt="email" />
        <a href="mailto:dmshikder@gmail.com" className='p-text'>mailto:dmshikder@gmail.com</a>

      </div>
      <div className='app__footer-card'>
        <img src={images.mobile} alt="mobile" />
        <a href="tel:+880 01706666653" className='p-text'>+880 01706666653</a>
      </div>
    </div>
